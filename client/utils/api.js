...
// export const API_BASE_URL = "https://ats-next-express.onrender.com";
...
export const fetchJobById = async (id) => {
  return await fetchWithAuth(`/api/jobs/${id}`);
};

export const createJob = async (jobData) => {
  return await fetchWithAuth("/api/jobs", {
    method: "POST",
...
export const fetchApplicationById = async (id) => {
  return await fetchWithAuth(`/api/applications/${id}`);
};

export const submitApplication = async (applicationData) => {
  return await fetchWithAuth("/api/applications", {
    method: "POST",
...
export const fetchAdminOverview = async () => {
  return await fetchWithAuth("/api/admin/overview");
};
...
export const updateApplicationStatus = async (id, status, notes) => {
  return await fetchWithAuth(`/api/pipeline/${id}/update`, {
    method: "POST",
...
export const fetchPipelineHistory = async (applicationId) => {
  return await fetchWithAuth(`/api/pipeline/${applicationId}`);
};

export const fetchAdminAnalytics = async () => {
  return await fetchWithAuth("/api/admin/analytics");
};
